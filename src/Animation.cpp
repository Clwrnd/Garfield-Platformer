...
Animation::Animation(const std::string &nameVar, const sf::Texture &t, size_t frameCount, size_t speed_var)
    : name(nameVar), frame_count(frameCount), speed(speed_var), current_frame(0), sprite(t)
{
